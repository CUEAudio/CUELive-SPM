...
let package = Package(
    ...
    targets: [
		.binaryTarget(
			name: "CUELive",
			url: "https://s3.amazonaws.com/swift-package-manager/binaries/CUELive/3.10.0/CUELive.3.10.0.xcframework.zip",
			checksum: "e92ccd43635fc110e0951aaa0917b465d7f9c9864c4642e1bcceeb7354675daa"
		),
		.binaryTarget(
			name: "CUEBluetooth",
