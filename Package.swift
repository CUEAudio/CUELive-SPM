...
let package = Package(
    ...
    targets: [
		...
		.binaryTarget(
			name: "CUELive",
			url: "https://s3.amazonaws.com/swift-package-manager/binaries/CUELive/3.9.18/CUELive.3.9.18.xcframework.zip",
			checksum: "08b458aa871e7321a943d2326be0f6ccaa9088e0e0016553540cc0bd5dcc0829"
		),
        .binaryTarget(
             name: "CueLightShow",
